  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new, color: context.colors.ink),
          onPressed: () {
        ...
        bottom: PreferredSize(
          ...
          child: Divider(height: 1, color: context.colors.hairline),
        ),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            if (args.isNotEmpty) const SizedBox(height: AppSpacing.xxl),
